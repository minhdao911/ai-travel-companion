travel_details_schema = {
    ...
    "properties": {
        "origin_airport_code": {
            "type": "string",
            "description": "The 3-letter airport code for departure",
        },
        "destination_airport_code": {
            "type": "string",
            "description": "The 3-letter airport code for arrival",
        },
        "origin_city_name": {
            "type": "string",
        ...
        "start_date": {
            "type": "string",
            "description": "Departure date in format like 2025-05-02",
        },
        "end_date": {
            "type": "string",
            "description": "Return date in format like 2025-05-09",
        },
        ...
        "accommodation": {
            ...
            "properties": {
                "type": {
                    "type": "array",
                    "description": "Type of accommodation (hotel, hostel, etc.)",
                    "items": {"type": "string"},
                },
                "max_price_per_night": {
                    "type": "integer",
                ...
                "free_cancellation": {
                    "type": "boolean",
                    "description": "Whether free cancellation is preferred",
                },
                "amenities": {
                    "type": "array",
        ...
        "flight": {
            ...
            "properties": {
                ...
                "direct": {
                    "type": "boolean",
                    "description": "Whether direct flights are preferred",
                },
            },
        },
        "activities": {
